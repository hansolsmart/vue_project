    ...
    <main class="mt-3">
        <div class="container">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-6 d-grid p-1">
                    <button type="button" class="btn btn-lg btn-danger" @click="goToList">저장하기</button>
                </div>
            </div>
            <!-- 1 -->
        </div>
        ...
        methods:{
            ...
            async getCategoryList(){
                ...
                category2.forEach(item => {
                    oCategory[item.category2] = item.id;
                });
            ...
            productInsert(){
                ...
                if(this.product.delivery_price == "" || this.product.product_price == 0){
                    return this.$swal("배송료를 입력하세요.");
                }
                if(this.product.outbound_days == "" || this.product.product_price == 0){
