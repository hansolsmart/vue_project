    ...
    <main class="mt-3">
        <div class="container">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-2" :key="i" v-for="(m,i) in productImage.fliter(c=>c.type==1)">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-2" :key="i" v-for="(m,i) in productImage.fliter(c=>c.type==2)">
                            <div class="positon-relative">
                                <img :src="'/download/${productId}/${m.path}'" alt="" class="img-fluid">
                                <div class="positon-absolute top-0 end-0" style="cursor:pointer;" @click="deleteImage(m.id)">X</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-4" :key="i" v-for="(m,i) in productImage.fliter(c=>c.type==3)">
                            <div class="position-relative">
                                <img :src="'/download/${productId}/${m.path}'" alt="" class="img-fluid">
                                <div class="positon-absolute top-0 end-0" style="cursor:pointer;color:white;" @click="deleteImage(m.id)">X</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        mounted(){
            ...
            async uploadFile(files, type){
                ...
                if(error){
                    return this.$swal("이미지 업로드를 실패했습니다. 다시 시도하세요.");
                }
