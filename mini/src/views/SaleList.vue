            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr :key="i" v-for="(product, i) in productList">
                        <td><img src="../download/images/keyboard.jpg" style="width:auto; height:50px;"></td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-warning me-1" @click="goToUpdate(product.id);">수 정</button>
                            <button type="button" class="btn btn-danger" @click="deleteProduct (product.id);">삭 제 </button>
                        </td>
                    </tr>
                </tbody>
            </table>
