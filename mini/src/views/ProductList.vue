            ...
            <div class="col-xl-3 col-lg-4 col-md-6" :key="i" v-for="(product,i) in productList">
                <div class="card" style="width: 18rem;">
                    <a @click="goToDetail(product.id);" style="cursor:pointer;">
                        <img :src="'/download/${product.id}/${product.path}'" class="card-img-top" alt="제품이미지">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title">{{product.product_name}}</h5>
                        <p class="card-text">
                            <span class="badge bg-dark text-white">{{product.category1}}</span>
                            <span class="badge bg-dark mx-2 text-white">{{product.category2}}</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="text-dark">20000원</small>
                        </div>
                    </div>
                </div>
            </div>
